...
if __name__ == "__main__":
    ...
    def all_bits(bit_num):
        return 2 ** bit_num - 1;

    def callback(bits, value):
        facility_parity = value >> 25
        facility = (value >> 22) & all_bits(8)
        id = (value >> 1) & all_bits(16)
        id_parity = value & 1
        print("bits={}, value={:#028b}, facility_parity={}, facility={}, id={}, id_parity={}".format(
            bits,
            bin(value),
            facility_parity,
            hex(facility),
